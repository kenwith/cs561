...
"""
Start up a Simple topology for CS561
"""
...
class CS561Controller( Controller ):
    "Controller for CS561 Multiple IP Bridge"
...
def cs561net():
    stophttp()
    "Create a simple network for cs561"
    get_ip_setting()
    topo = CS561Topo()
